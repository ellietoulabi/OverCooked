...
class Agent(object):
    ...
    def actions(self, states, agent_indices):
        """
        A multi-state version o=][f the action method. This enables for parallized
...
class RandomAgent(Agent):
    ...
    def __init__(
        ...
        '''    
        - sim_threads: Specifies the number of simulation threads to use when calling direct_action.
        - all_actions: A boolean flag to determine if the agent should consider all actions, not just motion actions.
        - custom_wait_prob: Probability that the agent will choose the "stay" action, allowing for a controlled chance that the agent will wait instead of randomly moving.
        '''
...
class GreedyHumanModel(Agent):
    ...
    def __init__(
        self,
        mlam,
        hl_boltzmann_rational=False, #High-Level Boltzmann Rationality
